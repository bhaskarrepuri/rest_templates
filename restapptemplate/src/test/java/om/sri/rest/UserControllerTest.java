...
/**
 * Created by Srinivas Repuri on 2017-09-01.
 */
...
public class UserControllerTest {
	...
	@Test
	@WithMockUser(roles = "ADMIN")
	public void loadallauthorities() throws Exception {
		this.mvc.perform(get("/api/loadallauthorities")).andExpect(status().is2xxSuccessful());
	}
}
